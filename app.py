...
# Configuration
# Default to SQLite for instant deployment if no DATABASE_URL is provided
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL', 'sqlite:///nextbuy.db')
